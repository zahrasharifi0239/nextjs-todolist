...
export const Header: FC = () => {
	...
	return (
		<header className="font-bold sticky left-0 top-0 w-full border-b border-b-regular  text-sm sm:text-xl bg-background p-4">
			<div className="font-bold mx-auto flex w-full max-w-4xl justify-between">
				<div className="flex gap-2">
					<Image src="/assets/svg/logo.svg" alt="logo" width={30} height={30} />
					<Typography.Text className="text-font-regular">
						{t('title')}
					</Typography.Text>
				</div>
